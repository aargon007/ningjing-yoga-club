...
const InstructorHome = () => {
	...
	return (
		<div>
			<div className="max-w-2xl sm:mx-auto bg-white shadow-xl rounded-lg text-gray-900">
				...
				<ul className="py-4 mt-2 text-gray-700 flex items-center justify-around">
					<li className="flex flex-col items-center justify-around">
						<FaStar className="w-4 fill-current text-blue-900"></FaStar>
						<div>30</div>
					</li>
					<li className="flex flex-col items-center justify-between">
						<FaUserFriends className="w-4 fill-current text-blue-900"></FaUserFriends>
						<div>550</div>
					</li>
					<li className="flex flex-col items-center justify-around">
						<FaChalkboardTeacher className="w-4 fill-current text-blue-900"></FaChalkboardTeacher>
						<div>15</div>
					</li>
				</ul>
			</div>
			...
			<div className="container relative z-40 mx-auto mt-12 shadow-xl">
				<div className="flex flex-wrap justify-center mx-auto lg:w-full md:w-5/6 xl:shadow-small-blue">
					<Link to='/dashboard/profile'
						className="block w-1/2 py-10 text-center bg-white border lg:w-1/3 border-gray  hover:bg-gradient-to-l from-green-200 to-green-300 relative overflow-hidden"
					>
						<div>
							<img
					...
					<Link to='/dashboard/my-classes'
						className="block w-full py-10 text-center bg-white border lg:w-1/3 border-gray  hover:bg-gradient-to-l from-green-200 to-green-300 relative overflow-hidden"
					>
						<div>
							<img
